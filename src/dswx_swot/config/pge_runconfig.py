...
from .runconfig import DSWxWorkflow, InputOptions, OutputOptions, WorkerSettings
...
class RunConfig(YamlModel):
    ...
    name: ClassVar[str] = "dswx-swot_workflow"
    ...
    log_file: Optional[Path] = Field(
        default=Path("output/dswx-swot_workflow.log"),
    ...
    def to_workflow(self):
        """Convert to a `DSWx_Workflow` object."""
        # We need to go from the PGE format to dswx_swot's DSWx_Workflow:
        ...
        # DSWx_Workflow are the input files,
